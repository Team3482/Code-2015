...
public class OI {
    ...
    public OI() {
        ...
        closeArmsArcadeButton = new JoystickButton(arcadeButtons, 4);
        closeArmsArcadeButton.whenPressed(new OpenArms(false));
        
        openArmsArcadeButton = new JoystickButton(arcadeButtons, 3);
        openArmsArcadeButton.whenPressed(new OpenArms(true));
        
        // xbox buttons
        rampButton = new JoystickButton(xboxController, 8);
        ...
        lowerArmsButton = new JoystickButton(xboxController, 1);
        ...
        raiseArmsButton = new JoystickButton(xboxController, 2);
